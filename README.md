...
# Building Cars (Introduction)

Inside the "A_YOUR_CAR" folder you should see various files with OBJ. and MTL. file extensions.
...
PART it into the respective parts:
...
# Example on a completed car

You can use the car model inside the "B_COMPLETE_CAR" folder as an example on how to build your car:

Inside the "B_COMPLETE_CAR" folder, there are two folders: Blend, and Wavefront (Legacy).
...
You can see in the Output, that it's empty and has no arrays yet. 
...
6: Navigate to the folder with car parts.

In this case, navigate to the Wavefront (Legacy) folder with Skyline's car parts.
...
Notice, that the output has changed in Visual Studio Code.
![image](https://user-images.githubusercontent.com/52705052/236937633-98ce23a3-52df-468f-ae11-656037f1a434.png)


10: Go back to Blender and export the rest of the car's parts.
